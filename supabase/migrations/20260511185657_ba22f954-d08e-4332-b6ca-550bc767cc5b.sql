...
DROP POLICY IF EXISTS "incidents_insert_auth" ON public.incident_reports;
DROP POLICY IF EXISTS "incidents_delete_own" ON public.incident_reports;
...
DROP POLICY IF EXISTS "snapshots_select_own" ON public.route_score_snapshots;
DROP POLICY IF EXISTS "snapshots_insert_own" ON public.route_score_snapshots;
